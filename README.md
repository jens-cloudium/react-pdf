<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@ascellus-pdf/renderer">
      <img src="https://img.shields.io/npm/v/@ascellus-pdf/renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @ascellus-pdf/renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@ascellus-pdf/renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@ascellus-pdf/renderer';
...
---
![](https://img.shields.io/npm/dt/@ascellus-pdf/renderer.svg?style=flat)
